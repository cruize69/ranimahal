...
const FALLBACK: CateringData = {
  packages: [
    { name: "Essentials", blurb: "Office lunches, small team meetings", items: ["Samosa or Vegetable Pakora", "Chicken Tikka Masala or Chicken Makhni + Palak Paneer", "Dal Maharani Makhni", "Basmati Rice", "Garlic Naan", "Raita"], photo: null, tiers: [{ itemId: "catering-essentials", label: null, price: 19.99, minimum: 15 }] },
    { name: "Signature", blurb: "Private parties, milestone celebrations, larger office events", items: ["Samosa + Chicken Malai Kabab", "3 mains + Palak Paneer", "Dal Maharani Makhni", "Basmati Rice (or Chicken Biryani, +$2/person)", "Garlic + Onion Naan", "Raita + Mango Chutney"], photo: null, tiers: [
    ...
    { name: "Rani Feast", blurb: "Weddings, large celebrations, the full tandoor experience", items: ["Tandoori Chicken or Chicken Tikka starter", "4 mains including a seafood option", "Chicken or Vegetable Biryani", "Dal Maharani Makhni", "Garlic, Onion + Peshwari Naan", "Raita, Mango Chutney + Chef's Special Salad"], photo: null, tiers: [
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (Array.isArray(data?.packages) && typeof data?.orderMinimum === "number") {
        return { packages: data.packages, orderMinimum: data.orderMinimum };
      }
    }
  } catch {
